...
public interface TaskService {
    ...
    EntityListResponse<TaskExecutionLogDTO> getTelsPaged(UUID task, Collection<UUID> methodIds, Collection<UUID> stateIds, String parameter, Date startDate, Date endDate,
