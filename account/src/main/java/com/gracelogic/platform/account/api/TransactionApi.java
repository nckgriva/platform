...
public class TransactionApi extends AbstractAuthorizedController {
    ...
    public ResponseEntity transactions(@RequestParam(value = "userId", required = false) UUID userId,
        ...
        EntityListResponse<TransactionDTO> transactions = accountService.getTransactionsPaged(userId, accountId, transactionTypeId != null ? Collections.singletonList(transactionTypeId) : null, startDate, endDate, false, length, null, start, sortField, sortDir);
